					...
					*/}
					<Flex me={openSidebar ? "" : "5"} mx={openSidebar ? "14" : "1"} display={{ sm: "none", xl: "flex" }}>
						{largeLogo && largeLogo[0]?.logoLgImg || largeLogo && largeLogo[0]?.logoSmImg ? <Image
							style={{ width: openSidebar ? "171px" : "60px", height: '52px', objectFit: "contain" }}
							...
							userSelect="none"
							my={2}
						/> : <Heading my={4} style={{ width: openSidebar ? "171px" : "65px", height: '52px', objectFit: "contain" }}
							cursor={"pointer"} onClick={() => !props.from && setOpenSidebar(!openSidebar)} userSelect={"none"}>{openSidebar === true ? "Evenmore" : "Er"}</Heading>}
					</Flex>
					...
					>
						{largeLogo && largeLogo[0]?.logoLgImg ? <Image
							...
							my={2}
						/> : <Heading my={4}
							cursor={"pointer"} userSelect={"none"}>{openSidebar === true ? "Evenmore" : "Er"}</Heading>}
					</Link>
